  ...
  <main class="py-6 px-4 sm:p-6 md:py-10 md:px-8">
    ...
    >
      ...
      >
        ...
        >
          Hi My Name is Hakeem 22FTT1511
        </h1>
        <p
      ...
      >
        ...
        <dd class="text-indigo-600 flex items-center dark:text-indigo-400">
          ...
          <span
            >Like: Anime<span class="text-slate-400 font-normal"></span
          ></span>
        </dd>
      ...
      >
        I'm a focused student programmer aiming to fast-track my graduation,
        driven by a strong ambition to swiftly enter the tech industry and start
        making a meaningful impact. With unwavering dedication, I prioritize
        skill development and academic efficiency to achieve my goal of entering
        the professional programming world.
      </p>
    </div>
  </main>
</template>
